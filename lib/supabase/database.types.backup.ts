// TypeScript definitions for Supabase database with enhanced schema
  ...
  public: {
    Tables: {
      ...
      project_buckets: {
        ...
        Relationships: [
          {
            foreignKeyName: "project_buckets_lab_id_fkey"
            columns: ["lab_id"]
      ...
      user_profiles: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "user_profiles_last_selected_lab_id_fkey"
            columns: ["last_selected_lab_id"]
            referencedRelation: "labs"
            referencedColumns: ["id"]
          }
        ]
      ...
      studies: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "studies_principal_investigator_id_fkey"
            columns: ["principal_investigator_id"]
            referencedRelation: "users"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "studies_primary_bucket_id_fkey"
            columns: ["primary_bucket_id"]
      ...
      files: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "files_study_id_fkey"
            columns: ["study_id"]
            referencedRelation: "studies"
            referencedColumns: ["id"]
          },
      ...
      standup_meetings: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "standup_meetings_created_by_fkey"
            columns: ["created_by"]
            referencedRelation: "users"
            referencedColumns: ["id"]
          }
      ...
      standup_action_items: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "standup_action_items_assignee_id_fkey"
            columns: ["assignee_id"]
            referencedRelation: "users"
            referencedColumns: ["id"]
          },
          ...
          {
            foreignKeyName: "standup_action_items_mentioned_by_fkey"
      ...
      workflow_steps: {
        ...
        Relationships: [
          {
            foreignKeyName: "workflow_steps_user_id_fkey"
            columns: ["user_id"]
            referencedRelation: "users"
            referencedColumns: ["id"]
          },
    ...
    Enums: {
      user_role: 'PRINCIPAL_INVESTIGATOR' | 'CO_PRINCIPAL_INVESTIGATOR' | 'DATA_SCIENTIST' | 'DATA_ANALYST' | 'CLINICAL_RESEARCH_COORDINATOR' | 'REGULATORY_COORDINATOR' | 'STAFF_COORDINATOR' | 'LAB_ADMINISTRATOR' | 'FELLOW' | 'MEDICAL_STUDENT' | 'RESEARCH_ASSISTANT' | 'VOLUNTEER_RESEARCH_ASSISTANT' | 'EXTERNAL_COLLABORATOR' | 'PI' | 'RESEARCH_COORDINATOR' | 'RESEARCHER' | 'STUDENT' | 'ADMIN'
      study_status: 'PLANNING' | 'IRB_SUBMISSION' | 'IRB_APPROVED' | 'DATA_COLLECTION' | 'ANALYSIS' | 'MANUSCRIPT' | 'UNDER_REVIEW' | 'PUBLISHED' | 'ON_HOLD' | 'CANCELLED'
      task_status: 'TODO' | 'IN_PROGRESS' | 'REVIEW' | 'DONE' | 'BLOCKED'
      priority: 'LOW' | 'MEDIUM' | 'HIGH' | 'URGENT'
      funding_type: 'NIH' | 'NSF' | 'INDUSTRY_SPONSORED' | 'INTERNAL' | 'FOUNDATION' | 'OTHER'
    }
  }
}